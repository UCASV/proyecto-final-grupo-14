...
CONSTRAINT PK_cab_emp PRIMARY KEY(employee_id, cabin_id) 
);
...
ALTER TABLE LOGIN_RECORD ADD CONSTRAINT PK_emp FOREIGN KEY (employee_id) REFERENCES EMPLOYEE (id);
ALTER TABLE LOGIN_RECORD ADD CONSTRAINT PK_cab FOREIGN KEY (cabin_id) REFERENCES CABIN (id);
